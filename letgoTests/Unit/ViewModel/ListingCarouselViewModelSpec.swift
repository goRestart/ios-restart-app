    ...
    override func spec() {
        ...
        describe("ListingCarouselViewModelSpec") {
            ...
            func buildSut(productListModels: [ListingCellModel]? = nil,
                ...
                sut.objects.observable.bind(to: cellModelsObserver).addDisposableTo(disposeBag)
                sut.productInfo.asObservable().bind(to: productInfoObserver).addDisposableTo(disposeBag)
                sut.productImageURLs.asObservable().bind(to: productImageUrlsObserver).addDisposableTo(disposeBag)
                sut.userInfo.asObservable().bind(to: userInfoObserver).addDisposableTo(disposeBag)
                sut.listingStats.asObservable().bind(to: productStatsObserver).addDisposableTo(disposeBag)
                sut.navBarButtons.asObservable().bind(to: navBarButtonsObserver).addDisposableTo(disposeBag)
                sut.actionButtons.asObservable().bind(to: actionButtonsObserver).addDisposableTo(disposeBag)
                sut.status.asObservable().bind(to: statusObserver).addDisposableTo(disposeBag)
                sut.isFeatured.asObservable().bind(to: isFeaturedObserver).addDisposableTo(disposeBag)
                sut.quickAnswers.asObservable().bind(to: quickAnswersObserver).addDisposableTo(disposeBag)
                sut.quickAnswersAvailable.asObservable().bind(to: quickAnswersAvailableObserver).addDisposableTo(disposeBag)
                sut.directChatEnabled.asObservable().bind(to: directChatEnabledObserver).addDisposableTo(disposeBag)
                sut.directChatPlaceholder.asObservable().bind(to: directChatPlaceholderObserver).addDisposableTo(disposeBag)
                sut.directChatMessages.observable.bind(to: directChatMessagesObserver).addDisposableTo(disposeBag)
                sut.isFavorite.asObservable().bind(to: isFavoriteObserver).addDisposableTo(disposeBag)
                sut.favoriteButtonState.asObservable().bind(to: favoriteButtonStateObserver).addDisposableTo(disposeBag)
                sut.shareButtonState.asObservable().bind(to: shareButtonStateObserver).addDisposableTo(disposeBag)
                sut.bumpUpBannerInfo.asObservable().bind(to: bumpUpBannerInfoObserver).addDisposableTo(disposeBag)
                sut.socialMessage.asObservable().bind(to: socialMessageObserver).addDisposableTo(disposeBag)
                sut.socialSharer.asObservable().bind(to: socialSharerObserver).addDisposableTo(disposeBag)
            }
