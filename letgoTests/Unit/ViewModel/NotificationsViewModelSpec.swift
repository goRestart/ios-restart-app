                ...
                context("finishes successfully") {
                    context("with zero items") {
                        beforeEach {
                            ...
                            sut = NotificationsViewModel(notificationsRepository: notificationsRepository , listingRepository: MockProductRepository(),
                    ...
                    context("with items") {
                        beforeEach {
                            ...
                            sut = NotificationsViewModel(notificationsRepository: notificationsRepository ,
                                                         listingRepository: MockProductRepository(), userRepository: MockUserRepository(),
