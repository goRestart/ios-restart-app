        ...
        describe("MainProductsViewModelSpec") {
            ...
            context("Initialization") {
                it("has firstDate nil (first time in Letgo)") {
                    ...
                    sut = MainProductsViewModel(sessionManager: Core.sessionManager, myUserRepository: Core.myUserRepository, trendingSearchesRepository: Core.trendingSearchesRepository, listingRepository: Core.listingRepository, monetizationRepository: Core.monetizationRepository, locationManager: Core.locationManager, currencyHelper: Core.currencyHelper, tracker: TrackerProxy.sharedInstance, filters: filters, keyValueStorage: keyValueStorage, featureFlags: mockFeatureFlags, bubbleTextGenerator: DistanceBubbleTextGenerator())
            ...
            context("Product list VM succeeded retrieving products") {
                ...
                context("with no filter and no search") {
                    beforeEach {
                        ...
                        sut = MainProductsViewModel(sessionManager: Core.sessionManager, myUserRepository: Core.myUserRepository, trendingSearchesRepository: Core.trendingSearchesRepository, listingRepository: Core.listingRepository, monetizationRepository: Core.monetizationRepository, locationManager: Core.locationManager, currencyHelper: Core.currencyHelper, tracker: mockTracker, searchType: searchType, filters: userFilters, keyValueStorage: keyValueStorage, featureFlags: mockFeatureFlags, bubbleTextGenerator: DistanceBubbleTextGenerator())
