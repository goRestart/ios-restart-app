...
final class LGChangePasswordBuilderSpec: QuickSpec {
    override func spec() {
        var subject: LGChangePasswordBuilder?
        
        context("when the mode is standard") {
            class NavigationController: UINavigationController {}
            
            beforeEach {
                subject = LGChangePasswordBuilder.standard(root: NavigationController())
            }
            ...
            describe("buildChangePassword") {
                ...
                beforeEach {
                    controller = subject?.buildChangePassword()
                }
        ...
        context("when the mode is modal") {
            ...
            beforeEach {
                subject = LGChangePasswordBuilder.modal
            }
