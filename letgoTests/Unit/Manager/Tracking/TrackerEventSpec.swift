    ...
    override func spec() {
        ...
        describe("factory methods") {
            ...
            describe("searchComplete") {
                it("has its event name") {
                    sut = TrackerEvent.searchComplete(nil, searchQuery: "", success: true)
                ...
                it("contains the search keyword related params when passing by the search query") {
                    sut = TrackerEvent.searchComplete(nil, searchQuery: "iPhone", success: true)
                ...
                it("search had no results") {
                    sut = TrackerEvent.searchComplete(nil, searchQuery: "weirdsearchterm", success: false)
