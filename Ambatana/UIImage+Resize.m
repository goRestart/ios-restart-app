...
// crops a image to its center.
- (UIImage *) croppedCenteredImage {
    CGFloat minSize = MIN(self.size.width, self.size.height);
    CGFloat originX = (self.size.width - minSize) / 2.0;
    CGFloat originY = (self.size.height - minSize) / 2.0;
    
    CGRect bounds = CGRectMake(originX, originY, minSize, minSize);
