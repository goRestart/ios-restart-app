...
struct Constants {
    ...
    static let timeIntervalForADay: TimeInterval = TimeInterval.make(days: 1)
    static let timeIntervalForTwelveHours: TimeInterval = TimeInterval.make(hours: 12)
    static let timeIntervalForOneHour: TimeInterval = TimeInterval.make(hours: 1)
