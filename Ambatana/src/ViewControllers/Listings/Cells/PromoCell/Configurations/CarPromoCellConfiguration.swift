...
enum CarPromoCellConfiguration {
    ...
    private var configuration: PromoCellData {
        ...
        case .first(let showsPostButton):
            return PromoCellData(appearance: .backgroundImage(image: R.Asset.Verticals.CarPromos.Backgrounds.background1.image,
                                                              titleColor: .white,
        ...
        case .second(let showsPostButton):
            return PromoCellData(appearance: .backgroundImage(image: R.Asset.Verticals.CarPromos.Backgrounds.background2.image,
                                                              titleColor: .white,
                                                              buttonStyle: .secondary(fontSize: .verySmall, withBorder: false)),
                                 arrangement: .titleOnTop(showsPostButton: showsPostButton),
                                 attributedTitle: attributedTitle,
        ...
        case .third(let showsPostButton):
            return PromoCellData(appearance: .backgroundImage(image: R.Asset.Verticals.CarPromos.Backgrounds.background3.image,
                                                              titleColor: .white,
                                                              buttonStyle: .secondary(fontSize: .verySmall, withBorder: false)),
                                 arrangement: .titleOnTop(showsPostButton: showsPostButton),
                                 attributedTitle: attributedTitle,
        ...
        case .fourth(let showsPostButton):
            return PromoCellData(appearance: .backgroundImage(image: R.Asset.Verticals.CarPromos.Backgrounds.background4.image,
                                                              titleColor: .white,
                                                              buttonStyle: .secondary(fontSize: .verySmall, withBorder: false)),
                                 arrangement: .titleOnTop(showsPostButton: showsPostButton),
                                 attributedTitle: attributedTitle,
        ...
        case .fifth(let showsPostButton):
            return PromoCellData(appearance: .backgroundImage(image: R.Asset.Verticals.CarPromos.Backgrounds.background5.image,
                                                              titleColor: .white,
                                                              buttonStyle: .secondary(fontSize: .verySmall, withBorder: false)),
                                 arrangement: .titleOnTop(showsPostButton: showsPostButton),
                                 attributedTitle: attributedTitle,
