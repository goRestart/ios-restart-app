...
class GooogleAdxNativeView: GADNativeContentAdView {
    ...
    private func setupUI() {
        ...
        addSubviewsForAutoLayout([headlineView!, privacyImageView, mainImageView, mainTextLabel, callToActionLabel, adTextLabel])
        setupTitleLabel()
        setupPrivacyImage()
        setupMainTextLabel()
        setupMainImage()
