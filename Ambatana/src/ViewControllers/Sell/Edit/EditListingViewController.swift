...
final class EditListingViewController: BaseViewController, UITextFieldDelegate,
    ...
    private enum Layout {
        ...
        static let viewOptionGenericHeight: CGFloat = 50
        static let viewOptionVerticalCellHeight: CGFloat = 44
        static let loadingTitleDisclaimerLeadingConstraint: CGFloat = 8
        static let completeTitleDisclaimerLeadingConstraint: CGFloat = -20
        static let titleDisclaimerHeightConstraint: CGFloat = 16
        static let titleDisclaimerBottomConstraintVisible: CGFloat = 24
        static let titleDisclaimerBottomConstraintHidden: CGFloat = 8
        static let separatorOptionsViewDistance = LGUIKitConstants.onePixelSize
        static let carsInfoContainerHeight: CGFloat = 9 * viewOptionVerticalCellHeight + 8
        static let realEstateInfoContainerHeight: CGFloat = 4 * viewOptionVerticalCellHeight + 3
        static let realEstateTurkishContainerHeight: CGFloat = 4 * viewOptionVerticalCellHeight + 3
        static let servicesInfoContainerHeight: CGFloat = 2 * viewOptionVerticalCellHeight + 1
    }
    ...
    func setupUI() {
        ...
        separatorContainerViewsConstraints.forEach { $0.constant = Layout.separatorOptionsViewDistance }
        ...
        postFreeViewHeightConstraint.constant = Layout.viewOptionGenericHeight
        freePostViewSeparatorTopConstraint.constant = Layout.separatorOptionsViewDistance

        featureViewHeightConstraint.constant = viewModel.listingCanBeFeatured ? Layout.viewOptionGenericHeight : 0
        ...
        viewModel.titleDisclaimerStatus.asObservable().bind { [weak self] status in
            ...
            case .completed:
                ...
                if strongSelf.viewModel.titleAutogenerated.value || strongSelf.viewModel.titleAutotranslated.value {
                    ...
                    strongSelf.titleDisclaimerLeadingConstraint.constant = Layout.completeTitleDisclaimerLeadingConstraint
                    strongSelf.titleDisclaimerHeightConstraint.constant = Layout.titleDisclaimerHeightConstraint
                    strongSelf.titleDisclaimerBottomConstraint.constant = Layout.titleDisclaimerBottomConstraintVisible
                } else {
                    strongSelf.titleDisclaimer.isHidden = true
                    strongSelf.titleDisclaimerLeadingConstraint.constant = Layout.loadingTitleDisclaimerLeadingConstraint
                    strongSelf.titleDisclaimerHeightConstraint.constant = 0
                    strongSelf.titleDisclaimerBottomConstraint.constant = Layout.titleDisclaimerBottomConstraintHidden
                }
            case .ready:
    ...
    private func updateFreePostViews(_ active: Bool) {
        if active {
            ...
            priceContainerHeightConstraint.constant = Layout.viewOptionGenericHeight
            priceViewSeparatorTopConstraint.constant = Layout.separatorOptionsViewDistance
...
extension EditListingViewController {
    ...
    private func showCarsAttributesView() {
        ...
        verticalFieldsContainerConstraint.constant = Layout.carsInfoContainerHeight
    }
    ...
    private func showRealEstateAttributesView() {
        ...
        case .standard:
            ...
            heightContainer = Layout.realEstateInfoContainerHeight
        case .turkish:
            realEstateStandardContainer.isHidden = true
            realEstateTurkishContainer.isHidden = false
            heightContainer = Layout.realEstateTurkishContainerHeight
        }
    ...
    private func showServicesAttributesView() {
        ...
        if viewModel.shouldShowListingType {
            let listingTypeContainerHeight: CGFloat = Layout.viewOptionVerticalCellHeight
            verticalFieldsContainerConstraint.constant = Layout.servicesInfoContainerHeight + listingTypeContainerHeight
            showServiceListingTypeView()
        } else {
            verticalFieldsContainerConstraint.constant = Layout.servicesInfoContainerHeight
    ...
    private func showPaymentFrequencyView() {
        paymentFrequencyHeightConstraint.constant = Layout.viewOptionGenericHeight
        paymentFrequencyTopConstraint.constant = Layout.separatorOptionsViewDistance
    ...
    private func showServiceListingTypeView() {
        serviceListingTypeHeightConstraint.constant = Layout.viewOptionVerticalCellHeight
        serviceListingTypeTopConstraint.constant = Layout.separatorOptionsViewDistance
