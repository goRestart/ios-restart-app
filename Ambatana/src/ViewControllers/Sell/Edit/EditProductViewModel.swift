...
class EditProductViewModel: BaseViewModel, EditLocationDelegate {
    ...
    init(product: Product,
        ...
        self.category.value = product.category
    ...
    private func checkChanges() {
        ...
        else if initialProduct.category != category.value {
            hasChanges = true
        }
...
extension EditProductViewModel {
    ...
    fileprivate func trackComplete(_ product: Product) {
        ...
        let myUser = myUserRepository.myUser
        let event = TrackerEvent.productEditComplete(myUser, product: product, category: category.value,
