...
class EditListingViewModel: BaseViewModel, EditLocationDelegate {
    ...
    fileprivate var disclamerStatus: TitleDisclaimerStatus {
        if isRealEstate {
            return .clean
        } else {
    ...
    let realEstateNumberOfBedrooms = Variable<NumberOfBedrooms?>(nil)
    ...
    init(listing: Listing,
        ...
        case .realEstate(let realEstate):
            ...
            if let bedrooms = realEstate.realEstateAttributes.bedrooms,
                let numberOfBedrooms = NumberOfBedrooms(rawValue: bedrooms) {
            self.realEstateNumberOfBedrooms.value = numberOfBedrooms
            }
            if let bathrooms = realEstate.realEstateAttributes.bathrooms,
                let numberOfBathrooms = NumberOfBathrooms(rawValue: bathrooms) {
                self.realEstateNumberOfBathrooms.value = numberOfBathrooms
            }
        }
    ...
    var realEstateAttributes: RealEstateAttributes {
        return RealEstateAttributes(propertyType: realEstatePropertyType.value,
                                    ...
                                    bedrooms: realEstateNumberOfBedrooms.value?.rawValue,
...
extension EditListingViewModel {
    ...
    func userWritesTitle(_ text: String?) {
        ...
        titleDisclaimerStatus.value = disclamerStatus
    }
