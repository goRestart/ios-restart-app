...
class PostProductViewController: BaseViewController, PostProductViewModelDelegate {
    ...
    fileprivate var carDetailsViewCenterXCosntraint = NSLayoutConstraint()
    ...
    private func setupAddCarDetailsView() {
        ...
        carDetailsView.layout(with: view)
            ...
            .proportionalHeight()
            .centerX()
            .centerY(constraintBlock: { [weak self] in self?.carDetailsViewCenterXCosntraint = $0 })
    ...
    private func setupRx() {
        ...
        keyboardHelper.rx_keyboardOrigin.asObservable().bindNext { [weak self] origin in
            ...
            strongSelf.carDetailsViewCenterXCosntraint.constant = keyboardHeight/2
