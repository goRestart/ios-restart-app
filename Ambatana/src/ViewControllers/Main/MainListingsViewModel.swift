    ...
    */
    ...
    var categoryHeaderElements: [CategoryHeaderElement] {
        ...
        if isTaxonomiesAndTaxonomyChildrenInFeedEnabled {
            ...
            categoryHeaderElements.append(contentsOf: ListingCategory.visibleValuesInFeed(servicesIncluded: featureFlags.servicesCategoryEnabled.isActive, realEstateIncluded: featureFlags.realEstateEnabled.isActive,
