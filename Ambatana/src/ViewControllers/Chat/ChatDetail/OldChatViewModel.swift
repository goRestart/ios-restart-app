...
//
//
//    var chaUserDeletedMessage: NSAttributedString {
//        let icon = NSTextAttachment()
//        icon.image = UIImage(named: "ic_alert_gray")
//        let iconString = NSAttributedString(attachment: icon)
//        let chatDeletedMessage = NSMutableAttributedString(attributedString: iconString)
//        chatDeletedMessage.appendAttributedString(NSAttributedString(string: " "))
//        let message: String
