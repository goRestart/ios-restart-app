...
extension ProductViewController {
    ...
    private func setupBodyView() {
        nameAutogeneratedDisclaimerLabel.font = UIFont.productTitleDisclaimersFont
        nameAutogeneratedDisclaimerLabel.textColor = UIColor.darkGrayText
        nameAutotranslatedDisclaimerLabel.font = UIFont.productTitleDisclaimersFont
        nameAutotranslatedDisclaimerLabel.textColor = UIColor.darkGrayText

        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(ProductViewController.toggleDescriptionState))
        descriptionCollapsible.textColor = UIColor.darkGrayText
