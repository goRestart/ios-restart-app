...
public protocol OldProductViewModelDelegate: class {
    
    func viewModelDidUpdate(viewModel: OldProductViewModel)
    
    func viewModelDidStartSwitchingFavouriting(viewModel: OldProductViewModel)
    func viewModelDidUpdateIsFavourite(viewModel: OldProductViewModel)

    func viewModelDidStartRetrievingUserProductRelation(viewModel: OldProductViewModel)

    func viewModelShowReportAlert(viewModel: OldProductViewModel)
    func viewModelDidStartReporting(viewModel: OldProductViewModel)
    func viewModelDidUpdateIsReported(viewModel: OldProductViewModel)
    func viewModelDidCompleteReporting(viewModel: OldProductViewModel)
    func viewModelDidFailReporting(viewModel: OldProductViewModel, error: RepositoryError)

    func viewModelShowDeleteAlert(viewModel: OldProductViewModel)
    func viewModelDidStartDeleting(viewModel: OldProductViewModel)
    func viewModel(viewModel: OldProductViewModel, didFinishDeleting result: ProductResult)
    
    func viewModelDidStartMarkingAsSold(viewModel: OldProductViewModel)
    func viewModel(viewModel: OldProductViewModel, didFinishMarkingAsSold result: ProductResult)

    func viewModelDidStartMarkingAsUnsold(viewModel: OldProductViewModel)
    func viewModel(viewModel: OldProductViewModel, didFinishMarkingAsUnsold result: ProductResult)

    func viewModel(viewModel: OldProductViewModel, didFinishAsking chatVM: ChatViewModel)
}


public class OldProductViewModel: BaseViewModel, UpdateDetailInfoDelegate {
    ...
    // Delegate
    public weak var delegate: OldProductViewModelDelegate?
