...
enum ChatWrapperMessageType {
    ...
    case phone(String)
    case chatNorris(AssistantMeeting)
}
...
extension ChatWrapperMessageType {
    ...
    var quickAnswerType: EventParameterQuickAnswerType? {
        ...
        case .text, .chatSticker, .expressChat, .favoritedListing, .periscopeDirect, .phone, .chatNorris:
            return nil
        }
    }
    ...
    var isUserText: Bool {
        ...
        case .text:
            return true
        case .quickAnswer, .chatSticker, .expressChat, .favoritedListing, .periscopeDirect, .phone, .chatNorris:
            return false
        }
    }
