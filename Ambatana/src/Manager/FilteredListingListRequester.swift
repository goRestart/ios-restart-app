    ...
    private func rangeYearTitle(forCarFilters carFilters: CarFilters) -> String? {
        ...
        if let startYear = carFilters.yearStart,
            ...
            if endYear == SharedConstants.filterMinCarYear {
                return R.Strings.filtersCarYearBeforeYearString("\(SharedConstants.filterMinCarYear)")
            } else {
                return R.Strings.filtersCarYearBeforeYearString("\(SharedConstants.filterMinCarYear)") + " - " + String(endYear)
            }
        } else {
            // no year specified
            return nil
