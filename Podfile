...
#    pod "LGCoreKit",             "4.71.0", :inhibit_warnings => false
#    pod "LGCoreKit",            :path => "../letgo-ios-lgcorekit"
    pod "LGCoreKit",            :git => 'git@github.com:letgoapp/letgo-ios-lgcorekit.git', :branch => 'ABIOS-4957-payment-app-state', :inhibit_warnings => false
