...
#    pod "Leanplum-iOS-SDK",     "2.0.1"  # Obj-c
    pod "Leanplum-iOS-SDK", :git => 'https://github.com/Leanplum/Leanplum-iOS-SDK-internal', :commit => 'e0ec4f381536b37864fecc44d1a59aa10970c613'
    
    pod "NewRelicAgent",        "5.10.1"

    # letgo Core
#    pod "LGCoreKit",             "3.17.0"
#    pod "LGCoreKit",            :path => "../lgcorekit"
    pod "LGCoreKit",            :git => 'git@github.com:letgoapp/letgo-ios-lgcorekit.git', :commit => '039a6bea51982b62b4f8126b5a0267737a7aea23'
