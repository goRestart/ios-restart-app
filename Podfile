...
def shared_pods
    ...
    # letgo Core
    pod "LGCoreKit",             "4.25.4", :inhibit_warnings => false
#    pod "LGCoreKit",            :path => "../lgcorekit", :inhibit_warnings => false
#    pod "LGCoreKit",            :git => 'git@github.com:letgoapp/letgo-ios-lgcorekit.git', :commit => 'bb6de94af093892ebb1b9312fd3be6070b99480a', :inhibit_warnings => false
