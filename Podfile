...
def shared_pods
    ...
    pod "LGCoreKit",             "4.94.0", :inhibit_warnings => false
#    pod "LGCoreKit",            :path => "../letgo-ios-lgcorekit", :inhibit_warnings => false
#   pod "LGCoreKit",            :git => 'git@github.com:letgoapp/letgo-ios-lgcorekit.git', :branch => 'ABIOS-5219-AdsAndCategoryFromBackend', :inhibit_warnings => false
