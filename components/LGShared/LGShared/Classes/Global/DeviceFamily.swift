...
public enum DeviceFamily {
    ...
    public static var current: DeviceFamily {
    ...
    public func isWiderOrEqualThan(_ deviceFamily: DeviceFamily) -> Bool {
...
public func >=(lhs: DeviceFamily, rhs: DeviceFamily) -> Bool {
    switch (lhs, rhs) {
