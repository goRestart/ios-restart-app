...
extension SignUpLogInViewController {
    func setAccessibilityIds() {
        connectFBButton.set(accessibilityId: AccessibilityId.LGLogin.signUpLoginFacebookButton)
        connectGoogleButton.set(accessibilityId: AccessibilityId.LGLogin.signUpLoginGoogleButton)
        emailButton.set(accessibilityId: AccessibilityId.LGLogin.signUpLoginEmailButton)
        emailTextField.set(accessibilityId: AccessibilityId.LGLogin.signUpLoginEmailTextField)
        passwordButton.set(accessibilityId: AccessibilityId.LGLogin.signUpLoginPasswordButton)
        passwordTextField.set(accessibilityId: AccessibilityId.LGLogin.signUpLoginEmailTextField)
        usernameButton.set(accessibilityId: AccessibilityId.LGLogin.signUpLoginUserNameButton)
        usernameTextField.set(accessibilityId: AccessibilityId.LGLogin.signUpLoginUserNameTextField)
        showPasswordButton.set(accessibilityId: AccessibilityId.LGLogin.signUpLoginShowPasswordButton)
        forgotPasswordButton.set(accessibilityId: AccessibilityId.LGLogin.signUpLoginForgotPasswordButton)
        loginSegmentedControl.set(accessibilityId: AccessibilityId.LGLogin.signUpLoginSegmentedControl)
        helpButton.set(accessibilityId: AccessibilityId.LGLogin.signUpLoginHelpButton)
        navigationItem.leftBarButtonItem?.set(accessibilityId: AccessibilityId.LGLogin.signUpLoginCloseButton)
        sendButton.set(accessibilityId: AccessibilityId.LGLogin.signUpLoginSendButton)
    }
}
