...
extension MainSignUpViewController {
    func setAccesibilityIds() {
        connectFBButton.set(accessibilityId: AccessibilityId.LGLogin.mainSignUpFacebookButton)
        connectGoogleButton.set(accessibilityId: AccessibilityId.LGLogin.mainSignUpGoogleButton)
        signUpButton.set(accessibilityId: AccessibilityId.LGLogin.mainSignUpSignupButton)
        logInButton.set(accessibilityId: AccessibilityId.LGLogin.mainSignupLogInButton)
        closeButton?.set(accessibilityId: AccessibilityId.LGLogin.mainSignupCloseButton)
        helpButton?.set(accessibilityId: AccessibilityId.LGLogin.mainSignupHelpButton)
    }
}
