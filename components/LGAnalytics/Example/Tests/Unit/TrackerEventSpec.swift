        ...
        describe("factory methods") {
            ...
            describe("listingSellComplete product") {
                ...
                beforeEach {
                    ...
                    sut = TrackerEvent.listingSellComplete(listing,
                                                           buttonName: .done,
                                                           ...
                                                           typePage: .sell,
                                                           mostSearchedButton: .notApply,
                                                           machineLearningTrackingInfo: MachineLearningTrackingInfo.makeDefault())
                }
                it("has its event name") {
                    expect(sut.name.rawValue) == "product-sell-complete"
                }
                it("contains free-posting") {
                    let freePostingParameter = sut.params!.stringKeyParams["free-posting"] as? String
                    expect(freePostingParameter) == (listing.price.isFree ? "true" : "false")
                }
                it("contains product-id") {
                    let productId = sut.params!.stringKeyParams["product-id"] as? String
                    expect(productId) == listing.objectId
                }
