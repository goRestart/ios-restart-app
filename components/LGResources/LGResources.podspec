Pod::Spec.new do |s|
    ...
    s.script_phase = { 
        ...
        :script => 
        'find "$PODS_TARGET_SRCROOT"/ -type d -iname *.xcassets ' +
        '-exec "$PODS_ROOT"/SwiftGen/bin/swiftgen xcassets ' +
        '-p "$PODS_TARGET_SRCROOT"/LGResources/swiftgen-template/xcassets/letgo-swift4-template.stencil ' +
        '--param publicAccess ' +
        '-o "$PODS_TARGET_SRCROOT"/LGResources/Classes/Assets.swift {} +;' +
        '' +
        '"$PODS_ROOT"/SwiftGen/bin/swiftgen strings ' +
        '-p "$PODS_TARGET_SRCROOT"/LGResources/swiftgen-template/strings/letgo-flat-swift4.stencil ' +
        '--param publicAccess --param enumName=Strings ' +
