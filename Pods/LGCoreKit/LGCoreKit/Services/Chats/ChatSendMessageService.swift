...
public protocol ChatSendMessageService {
    ...
    */
    func sendMessageWithSessionToken(sessionToken: String, message: String, type: MessageType, recipientUserId: String, productId: String, result: ChatSendMessageServiceResult?)
}
