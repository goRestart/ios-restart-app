...
class LGMyUserRepository: InternalMyUserRepository {
    ...
    /**
     ...
     - parameter completion: completion closure
     */
    func linkAccount(email: String, completion: ((Result<MyUser, RepositoryError>) -> ())?) {
    ...
    /**
     ...
     - parameter completion: completion closure
     */
    func linkAccountFacebook(token: String, completion: ((Result<MyUser, RepositoryError>) -> ())?) {
    ...
    /**
     ...
     - parameter completion: completion closure
     */
    func linkAccountGoogle(token: String, completion: ((Result<MyUser, RepositoryError>) -> ())?) {
