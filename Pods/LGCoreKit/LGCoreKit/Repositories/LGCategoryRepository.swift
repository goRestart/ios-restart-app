...
final class LGCategoryRepository: CategoryRepository {
    ...
    func index(servicesIncluded: Bool, carsIncluded: Bool, realEstateIncluded: Bool, highlightRealEstate: Bool, completion: CategoriesCompletion?) {
        completion?(CategoriesResult(value: ListingCategory.visibleValues(servicesIncluded: servicesIncluded, carsIncluded: carsIncluded, realEstateIncluded: realEstateIncluded, highlightRealEstate: highlightRealEstate)))
    }
