...
enum WebSocketResponseType: String {
    ...
    case fetchInactiveConversationsCount = "inactive_conversations_count"
    case fetchInactiveConversations = "inactive_conversation_list"
    case pong = "pong"
    ...
    var superType: ResponseSuperType {
        ...
        case .interlocutorTypingStarted, .interlocutorTypingStopped, .interlocutorMessageSent,
             ...
             .talkerUnauthenticated, .smartQuickAnswer:
            return .event
        }
    }
}
