...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods/ClusterPrePermissions.framework"
  ...
  install_framework "Pods/LGCollapsibleLabel.framework"
  install_framework "Pods/LGCoreKit.framework"
  install_framework "Pods/LGSemiModalNavController.framework"
  install_framework "Pods/LGTour.framework"
