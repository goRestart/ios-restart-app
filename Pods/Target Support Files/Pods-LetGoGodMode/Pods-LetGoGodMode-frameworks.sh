...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-LetGoGodMode/Alamofire.framework"
  install_framework "Pods-LetGoGodMode/AlamofireImage.framework"
  install_framework "Pods-LetGoGodMode/Amplitude_iOS.framework"
  install_framework "Pods-LetGoGodMode/Argo.framework"
  install_framework "Pods-LetGoGodMode/Bolts.framework"
  ...
  install_framework "Pods-LetGoGodMode/JWT.framework"
  install_framework "Pods-LetGoGodMode/KeychainSwift.framework"
  install_framework "Pods-LetGoGodMode/LGCollapsibleLabel.framework"
  install_framework "Pods-LetGoGodMode/LGCoreKit.framework"
  install_framework "Pods-LetGoGodMode/LGSemiModalNavController.framework"
  install_framework "Pods-LetGoGodMode/Result.framework"
  install_framework "Pods-LetGoGodMode/RxBlocking.framework"
  install_framework "Pods-LetGoGodMode/RxCocoa.framework"
  install_framework "Pods-LetGoGodMode/RxSwift.framework"
